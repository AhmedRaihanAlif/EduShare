...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2022 at 09:23 PM
...
(5, 'Art ', '6307c8c039ff1'),
(6, 'Food Cooking', '6307c8c039ff1'),
(7, 'JavaScript', '6307c8c039ff1'),
(8, 'Phptoshop Editor', '6307c8c039ff1'),
(9, 'Animation Maker', '6307c8c039ff1'),
(10, 'Video Editor', '6307c8c039ff1');
...
('631cbcd81e785', 'Junior Developer', 'SoftTech', 3, 'Narayanganj', 'Full Time', 'Html, Css, JS, React ', '1-2 years', 45, '631cbb287121e', 1, 'approved', 'Bsc in cse', '2022-11-15 13:40:00'),
...
('63207ca2032b2', 'Writer', 'edusoft', 2, 'Narayanganj ', 'Work From Home', 'Excellent writing and editing skill ', '1-2 years  ', 20, '631f32f6eb444', 0, 'approved', 'Reputed institute certificates ', '2022-12-17 23:59:00'),
...
--
-- Table structure for table `searchexperts`
--

CREATE TABLE `searchexperts` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `searchexperts`
--

INSERT INTO `searchexperts` (`id`, `username`, `jobtype`, `education`, `experience`, `location`, `salary`, `Apply`) VALUES
(1, 'Siful Islam', 'Writer', 'Bsc in engineering', '2 years', 'Dhaka', '5k', '<a href=\"url\">link text</a>');
...
('631cbbe1417f4', 'Mainul Islam', 'Male', 'msiam183036@bscse.uiu.ac.bd', '01900112233', '1123', 'user', 777355, 'Verified', 'active', 'Sylhet', '2022-09-13 19:02:13', 'Bsc in cse', 'Web Developer', 'Software engineer', 'photoshop', '631cbbe1417f4profilepic.jpg'),
...
--
-- Indexes for table `searchexperts`
--
ALTER TABLE `searchexperts`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `searchexperts`
--
ALTER TABLE `searchexperts`
