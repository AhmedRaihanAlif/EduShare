            ...
            <div class="container ">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav ms-auto text-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="loginData.php">Log In</a>
                        </li>
        ...
        <div class="container">
            ...
            <div class="row d-flex justify-content-between align-items-center">
                ...
                <div class="col-12 col-md-12 col-lg-6 ol-xxl-6 col-xl-6 row d-flex justify-content-center card">
                    ...
                    <form action="/EduShare/signup.php" method="POST">
                        ...
                        <div class="row d-flex justify-content-center">
                            <div class="col-xl-6	col-lg-12 col-md-12 inputBox">
                                ...
                                <input type="password" name="pass1" placeholder="Enter Password(Min 8)">

                            </div>
                            <div class="col-xl-6	col-lg-12 col-md-12  inputBox">

                                <input type="password" name="pass2" placeholder="Confrim Password(Min 8)">
